...
ARTIFACT_DIR = ROOT / "docs" / "notes" / "_artifacts" / "social-s6-w3-card"
...
def _load_slate() -> tuple[dict[str, Any], str]:
    ...
    pub_path = ROOT / "data" / "webapp" / "publish_history" / "2026_w3.jsonl"
    if latest.is_file():
        ...
        source = (
            f"data/webapp/publish_history/2026_w3.jsonl "
...
def main() -> None:
    ...
    (ARTIFACT_DIR / "replies_w3.md").write_text(payload["replies_w3_md"], encoding="utf-8")
