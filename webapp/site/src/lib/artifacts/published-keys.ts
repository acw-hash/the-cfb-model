...
export const GAME_FIELD_CONSUMERS: Record<PublishedGamePredictionKey, string> = {
  ...
  mu_margin: "IntervalBand; ForecastBlock Margin; PlainSummary",
  sigma_margin: "IntervalBand rounding; ForecastBlock; formatTypicalMiss",
  sigma_margin_credible: "probabilityIsCredible σ-gate; GameRow win chance",
  margin_interval_lo: "IntervalBand; ForecastBlock; PlainSummary",
  margin_interval_hi: "IntervalBand; ForecastBlock; PlainSummary",
  margin_interval_nominal: "ForecastBlock coverage; PlainSummary N-in-10",
  ...
  p_win_home: "PlainSummary; GameRow win chance; About worked example",
  p_win_home_credible: "probabilityIsCredible; GameRow",
  conviction_tier: "TierChip; sort.ts; RevisionBlock explainer",
  conviction_team: "DESIGN §1.2 (label is rendered; team field not separately shown)",
  conviction_label: "TierChip; RevisionBlock; About worked example",
  ...
  null_reason: "IntervalBand; ForecastBlock; PlainSummary footnote",
